    ...
    <div>
        <div class="my-gallery" itemscope itemtype="http://schema.org/ImageGallery">
            ...
            <figure
                    ...
                    v-for="(item, index) in localItems" :src="item.src"
                    v-bind:key="index">
                ...
                <button
                        v-if="item.delete_link"
                        @click="deleteImage(item, index)"
                        class="delete_button delete_class"
                >
                    <i class="material-icons delete_class">
                        delete
                    </i>
                </button>
            </figure>
    ...
    export default {
        ...
        mounted() {
            ...
            let initPhotoSwipeFromDOM = function (gallerySelector) {
                ...
                let openPhotoSwipe = function (index, galleryElement, disableAnimation, fromURL) {
                    ...
                    localItems = parseThumbnailElements(galleryElement);
                    ...
                    options = {
                        ...
                        getThumbBoundsFn: function (index) {
                            ...
                            let thumbnail = localItems[index].el.getElementsByTagName('img')[0], // find thumbnail
                    ...
                    gallery = new PhotoSwipe(pswpElement, PhotoSwipeUI_Default, localItems, Object.assign(options, that.options));
        ...
        methods: {
            ...
            deleteImage(item, index) {
                let r = confirm("Biztos törölni szeretnéd a képet?");
                if (r == true) {
                    fetch(item.delete_link)
